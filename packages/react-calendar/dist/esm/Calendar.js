...
var Calendar = forwardRef(function Calendar(props, ref) {
    ...
    var availableState = useMemo(function () {
    ...
    function renderContent(next) {
        ...
        switch (view) {
            case 'century': {
                return (_jsx(CenturyView, __assign({ availableDates: availableState, formatYear: formatYear, showNeighboringCentury: showNeighboringCentury }, commonProps)));
            }
            case 'decade': {
                return (_jsx(DecadeView, __assign({ availableDates: availableState, formatYear: formatYear, showNeighboringDecade: showNeighboringDecade }, commonProps)));
            }
            case 'year': {
                return (_jsx(YearView, __assign({ formatMonth: formatMonth, formatMonthYear: formatMonthYear, availableDates: availableState }, commonProps)));
            }
            case 'month': {
                return (_jsx(MonthView, __assign({ availableDates: availableState, calendarType: calendarType, formatDay: formatDay, formatLongDate: formatLongDate, formatShortWeekday: formatShortWeekday, formatWeekday: formatWeekday, onClickWeekNumber: onClickWeekNumber, onMouseLeave: selectRange ? onMouseLeave : undefined, showFixedNumberOfWeeks: typeof showFixedNumberOfWeeks !== 'undefined'
