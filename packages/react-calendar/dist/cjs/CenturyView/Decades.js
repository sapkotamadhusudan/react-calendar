...
function Decades(props) {
    var activeStartDate = props.activeStartDate, hover = props.hover, showNeighboringCentury = props.showNeighboringCentury, value = props.value, valueType = props.valueType, availableDates = props.availableDates, otherProps = __rest(props, ["activeStartDate", "hover", "showNeighboringCentury", "value", "valueType", "availableDates"]);
    ...
    return ((0, jsx_runtime_1.jsx)(TileGroup_js_1.default, { className: "react-calendar__century-view__decades", dateTransform: date_utils_1.getDecadeStart, dateType: "decade", end: end, hover: hover, renderTile: function (_a) {
        ...
        }, start: start, step: 10, value: value, valueType: valueType, availableDates: availableDates }));
}
