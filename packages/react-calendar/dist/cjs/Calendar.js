...
function getInitialActiveStartDate(_a) {
    var activeStartDate = _a.activeStartDate, defaultActiveStartDate = _a.defaultActiveStartDate, defaultValue = _a.defaultValue, defaultView = _a.defaultView, maxDate = _a.maxDate, maxDetail = _a.maxDetail, minDate = _a.minDate, minDetail = _a.minDetail, value = _a.value, view = _a.view, availableDates = _a.availableDates;
    var rangeType = getView(view, minDetail, maxDetail);
...
var Calendar = (0, react_1.forwardRef)(function Calendar(props, ref) {
    ...
    var availableState = (0, react_1.useMemo)(function () {
        return Array.isArray(availableDates)
            ? availableDates.map(function (el) { return (el !== null ? toDate(el) : null); })
    ...
    function renderContent(next) {
        ...
        switch (view) {
            case 'century': {
                return ((0, jsx_runtime_1.jsx)(CenturyView_js_1.default, __assign({ availableDates: availableState, formatYear: formatYear, showNeighboringCentury: showNeighboringCentury }, commonProps)));
            }
            case 'decade': {
                return ((0, jsx_runtime_1.jsx)(DecadeView_js_1.default, __assign({ availableDates: availableState, formatYear: formatYear, showNeighboringDecade: showNeighboringDecade }, commonProps)));
            }
            case 'year': {
                return ((0, jsx_runtime_1.jsx)(YearView_js_1.default, __assign({ formatMonth: formatMonth, formatMonthYear: formatMonthYear, availableDates: availableState }, commonProps)));
            }
            case 'month': {
                return ((0, jsx_runtime_1.jsx)(MonthView_js_1.default, __assign({ availableDates: availableState, calendarType: calendarType, formatDay: formatDay, formatLongDate: formatLongDate, formatShortWeekday: formatShortWeekday, formatWeekday: formatWeekday, onClickWeekNumber: onClickWeekNumber, onMouseLeave: selectRange ? onMouseLeave : undefined, showFixedNumberOfWeeks: typeof showFixedNumberOfWeeks !== 'undefined'
