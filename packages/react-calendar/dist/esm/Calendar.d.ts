...
import type { CalendarType, ClassName, Detail, LooseValue, NavigationLabelFunc, OnArgs, OnClickFunc, OnClickWeekNumberFunc, TileClassNameFunc, TileContentFunc, TileDisabledFunc, Value, View, LooseAvailableArrayValue } from './shared/types.js';
