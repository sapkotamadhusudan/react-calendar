...
function Day(_a) {
    ...
    var date = otherProps.date, locale = otherProps.locale, _e = otherProps.availableDates, availableDates = _e === void 0 ? [] : _e;
    var classesProps = [];
    if (classes) {
        classesProps.push.apply(classesProps, classes);
    }
    if ((0, utils_js_1.isDateIncludedInList)(availableDates, date)) {
