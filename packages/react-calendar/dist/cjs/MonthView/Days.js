...
function Days(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(TileGroup_js_1.default, { className: "react-calendar__month-view__days", count: 7, dateTransform: function (day) {
            ...
            return ((0, jsx_runtime_1.jsx)(Day_js_1.default, __assign({}, otherProps, otherTileProps, { activeStartDate: activeStartDate, calendarType: calendarType, currentMonthIndex: monthIndex, date: date, availableDates: availableDates }), date.getTime()));
        }, offset: offset, start: start, value: value, valueType: valueType, availableDates: availableDates }));
}
